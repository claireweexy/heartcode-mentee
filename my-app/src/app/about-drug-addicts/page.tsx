...
export default function DrugAddicts() {
  const testimonials = [
    {
    quote:`Juice WRLD, born Jarad Higgins, was a talented rapper and singer known for his emotional lyrics and hits like Lucid Dreams. His music, had themes of love, heartbreak, and mental health, deeply resonated with fans, especially those facing similar issues. Despite success, Jarad battled substance abuse and mental health issues, often referencing his struggles in his songs. In December 2019, he tragically passed away at just 21 from a drug overdose, shocking the music world and shedding light on the dangers of addiction and the pressures of fame.
  Juice WRLD's story highlights the importance of mental health awareness and the need for support for those battling addiction. His music continues to inspire and provide comfort, leaving a lasting legacy.
    `,
      name: "Juice World",
      designation: "American rapper and singer",
      src: "/assets/juice world.jpg",
      story: `
These accounts are more than just cautionary tales; they are a stark wake-up call. They show us the ripple effect of addiction—how one person's struggle can fracture families, devastate friendships, and leave entire communities grappling with grief. They remind us that addiction is not a solitary battle; it pulls everyone into its orbit, leaving scars that last a lifetime.
...
Liam's addiction worsened during One Direction's rise, affecting his mental and emotional well-being. Seeking help and therapy marked the start of his recovery, allowing him to regain control of his life and prioritize his mental health.
His journey from struggle to redemption highlights the importance of seeking support and raising awareness about addiction and mental health challenges. Liam’s story inspires others to believe that recovery is always possible.
`,
      name: "Liam Payne",
...
`,
    ...
    {
      quote:
      `Mac Miller, born Malcolm James McCormick, was an American rapper known for his heartfelt lyrics and relatable music. Rising to fame with mixtapes like K.I.D.S. and Best Day Ever, he connected with fans through his reflections on life, love, and ambition.
    Despite his success, Mac battled addiction and mental health struggles, which became evident over time. The pressures of fame and personal challenges led to his tragic passing from an accidental drug overdose in September 2018.
    Mac Miller’s story is a powerful reminder of the dangers of addiction and the importance of mental health. Though he is gone, his music and legacy continue to inspire, highlighting the need to seek help and support during life’s hardest moments.
`,
      name: "Mac Miller",
      designation: "American rapper and singer",
      src: "/assets/mac 3.jfif",
...
`,
    ...
    {
      quote:
`,Sarah was a compassionate 24-year-old with a bright future, but her life took a tragic turn when she started dating someone involved in drugs. Though she initially resisted, she was eventually pressured into trying heroin, which led to a downward spiral she couldn’t escape.
...
`,
    ...
    {
      quote:
`Jake, a 32-year-old from a small town, shared a close bond with his older brother Aaron, whose life took a dark turn when he began experimenting with drugs in his late teens. Casual use quickly spiraled into addiction, and Jake watched helplessly as Aaron’s health and relationships crumbled.
